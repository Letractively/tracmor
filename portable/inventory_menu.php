...
?>
  ...
  <input type="text" name="menu_id" onkeyup="javascript:if (event.keyCode>48 && event.keyCode<53) document.main_form.submit(); else document.main_form.menu_id.value='';" size="3">
  </form>
