  	...
  	protected function dlgExchange_Create() {
		...
		protected function calShipDate_Create() {
			...
			$this->calShipDate->MinimumDay = $this->dttNow->Day;
      		...
      		if ($intDayOfWeek == 0) {
      			$this->dttFiveDaysFromNow = new QDateTime(date('m/d/Y', $this->dttNow->Timestamp + 432000));
      		}
      		// Monday - Friday, add seven days
      		elseif ($intDayOfWeek > 0 && $intDayOfWeek < 6) {
      			$this->dttFiveDaysFromNow = new QDateTime(date('m/d/Y', $this->dttNow->Timestamp + 604800));
      		}
      		// Saturday - add six days
      		elseif ($intDayOfWeek == 6) {
      			$this->dttFiveDaysFromNow = new QDateTime(date('m/d/Y', $this->dttNow->Timestamp + 518400));
      		}
