...
<!-- End Shortcut Menu -->
		...
		<div class="title">&nbsp;Shipment Search</div>
		<table style="border:1px solid #AAAAAA;background-color:#EEEEEE;font-family:verdana;font-size:10px;color:#444444;height:40px" width="100%">
			<tr>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtToCompany->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtToContact->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtShipmentNumber->RenderWithNameLeft("Width=100") ?>
				</td>
