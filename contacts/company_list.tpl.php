...
<!-- End Shortcut Menu -->
		...
		<div class="title">&nbsp;Company Search</div>
		<table style="border:1px solid #AAAAAA;background-color:#EEEEEE;font-family:verdana;font-size:10px;color:#444444;height:40px" width="100%">
			<tr>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtShortDescription->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtCity->RenderWithNameLeft("Width=100") ?>
				</td>
				<td></td>
				<td></td>
			...
			<tr>
				<td style="vertical-align:top;" noWrap>
					<?php $this->lstStateProvince->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->lstCountry->RenderWithNameLeft("Width=100") ?>
				</td>		
				<td></td>
				<td></td>
				<td>
