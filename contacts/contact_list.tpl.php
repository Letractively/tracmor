...
<!-- End Shortcut Menu -->
		...
		<div class="title">&nbsp;Contact Search</div>
		<table style="border:1px solid #AAAAAA;background-color:#EEEEEE;font-family:verdana;font-size:10px;color:#444444;height:40px" width="100%">
			<tr>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtFirstName->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtLastName->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtCompany->RenderWithNameLeft("Width=100") ?>
				</td>		
