...
<!-- End Shortcut Menu -->
		...
		<div class="title">&nbsp;Receipt Search</div>
		<table style="border:1px solid #AAAAAA;background-color:#EEEEEE;font-family:verdana;font-size:10;color:#444444;height:40" width="100%">
			<tr>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtFromCompany->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtFromContact->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtReceiptNumber->RenderWithNameLeft("Width=100") ?>
				</td>
			...
			<tr>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtAssetCode->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->txtInventoryModelCode->RenderWithNameLeft("Width=100") ?>
				</td>
				<td style="vertical-align:top;" noWrap>
					<?php $this->lstStatus->RenderWithNameLeft("Width=100") ?>
				</td>
				<td>
