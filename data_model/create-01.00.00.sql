...
CREATE TABLE custom_field_selection (
  custom_field_selection_id INTEGER UNSIGNED   NOT NULL   AUTO_INCREMENT,
  custom_field_value_id     INTEGER UNSIGNED   NOT NULL,
  entity_qtype_id           INTEGER UNSIGNED   NOT NULL,
  entity_id                 INTEGER UNSIGNED   NOT NULL,
    PRIMARY KEY ( custom_field_selection_id ),
    INDEX custom_field_selection_fkindex1 ( entity_qtype_id ),
    INDEX custom_field_selection_fkindex3 ( custom_field_value_id ),
    INDEX custom_field_selection_index4207 ( entity_id ))
TYPE = INNODB;
...
CREATE TABLE shortcut (
  ...
  create_flag       TINYINT(1) UNSIGNED   NOT NULL,
    ...
    INDEX shortcut_fkindex3 ( entity_qtype_id ))
TYPE = INNODB;
...
ALTER TABLE custom_field_selection
  ADD CONSTRAINT FOREIGN KEY( custom_field_value_id) references custom_field_value (
