...
<!-- End Shortcut Menu -->
		...
		<div class="title">Categories: <?php $this->lblHeaderCategory->Render(); ?></div>
		<table class="datagrid" cellpadding="5" cellspacing="0" border="0">
			...
			<tr>
				<td>
					<table>
						<tr>
							<td class="record_field_name">Category Name: </td>
						...
						<tr>
							<td class="record_field_name">Asset Category: </td>
							<td class="record_field_edit"><?php $this->chkAssetFlag->RenderWithError(); ?></td>
						</tr>
						<tr>
							<td class="record_field_name">Inventory Category: </td>
							<td class="record_field_edit"><?php $this->chkInventoryFlag->RenderWithError(); ?></td>
						</tr>
						<?php
						// Custom Fields
